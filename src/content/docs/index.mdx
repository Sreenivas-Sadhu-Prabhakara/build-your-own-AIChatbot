...
1. [**00 · Prerequisites**](/00-prerequisites/) — get your Mac ready.
2. [**01 · Serving stack**](/01-serving-stack/) — one OpenAI-compatible endpoint with fallback.
3. [**02 · Data layer**](/02-data-layer/) — Postgres + pgvector + a BGE-M3 embeddings server.
4. [**03 · Ingestion & RAG**](/03-ingestion-rag/) — chunk, embed, and search your docs by meaning.
5. [**04 · The solar brain**](/04-solar-brain/) — your first grounded Taglish answer.
6. [**05 · Guardrails**](/05-guardrails/) — on-topic, grounded, and safe.
7. [**06 · Chat service**](/06-chat-service/) — a streaming HTTP API with feedback + modes.
8. [**07 · Taglish voice LoRA**](/07-taglish-lora/) — fine-tune the persona into the model.
9. [**08 · Go live**](/08-go-live/) — reach your local brain from a public web app.

Then the [Appendix](/99-appendix/) covers troubleshooting, the ₱0 cost model, and swapping
models. Ready? [Start with the prerequisites →](/00-prerequisites/)
